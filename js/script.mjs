...
const 
    ...
    noticys = document.getElementsByClassName('card'),
    noticys_img = document.getElementsByClassName('imgcard'),
    noticys_title = document.getElementsByClassName('title_card'),
    noticys_pg = document.getElementsByClassName('pg_card'),
    banner = document.getElementById('bannerMain');
const 
    size = noticys.length,
